...
// Note: Firebase Admin SDK doesn't support multiple databases like client SDK
// We'll use the default database and ensure it's named 'kilvish' in Firebase Console
